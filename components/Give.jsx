  ...
  return (
    <section className="px-6 py-24 bg-white">
      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="mt-14 slide-left text-center border-l-4 border-purple-950 pl-6 italic text-gray-700">
        ...
        <div className="mt-14 slide-right text-left space-y-6">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-purple-950 tracking-widest">
              40810276593
            </p>
          </div>
