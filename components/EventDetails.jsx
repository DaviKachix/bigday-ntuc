    ...
    <section className="px-6 py-20 bg-white">
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h2 className="text-3xl font-bold text-orange-650">
          ...
          <div className="mt-6 space-y-3 text-gray-700">
            ...
            <p>
              <span className="font-semibold text-orange-650">
                {isEN ? "Event:" : "Tukio:"}
              </span>{" "}
          ...
          {/* CALL TO ACTION */}
          <button className="mt-8 bg-orange-650 text-white px-6 py-3 rounded-xl shadow hover:bg-orange-650 transition">
