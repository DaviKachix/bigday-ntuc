    ...
    <>
      ...
      <section className="relative max-w-6xl mx-auto px-6 md:px-10 py-16">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <h1 className="text-3xl md:text-4xl font-bold text-purple-950 leading-tight">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <div className="pt-4 space-y-2 text-sm text-gray-600 border-l-2 border-purple-950 pl-4">
        ...
        <div className="mt-16 pt-10 border-t border-gray-100 max-w-3xl mx-auto text-center">
          ...
          <p className="mt-6 font-semibold text-purple-950">
